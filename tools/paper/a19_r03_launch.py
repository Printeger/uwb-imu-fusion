#!/usr/bin/env python3
"""Estimator-free launch preparation for the single R03 attempt."""
import json
import os
...
def prepare_attempt(evidence: Path, attempt: str) -> dict:
    ...
    write_json_atomic(status, {
        "schema": "A19_R03_LAUNCH_STATUS_V1", "attempt": attempt,
        "parent_exists": pilot_parent.is_dir(),
        "parent_writable": os.access(pilot_parent, os.W_OK),
        "output_leaf": str(output_leaf), "output_leaf_exists": False,
        "estimator": "NOT_RUN"})
