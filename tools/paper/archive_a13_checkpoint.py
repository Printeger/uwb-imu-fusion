#!/usr/bin/env python3
"""Seal and verify A13 artifacts without any estimator or truth access."""
...
assert not any(set(p.relative_to(r).parts) & {'evaluation', 'truth', 'gt'} for p in r.rglob('*'))
...
with tempfile.TemporaryDirectory(prefix='a13_archive_verify_') as td:
