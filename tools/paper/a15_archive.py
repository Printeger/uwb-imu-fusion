#!/usr/bin/env python3
"""Archive finalized A15 payload, then independently extract/hash every file."""
...
def main():
 ...
 inventory={'schema':'t10_a15_payload_inventory_v1','entries':entries}
 ...
 failures=[]
 with tempfile.TemporaryDirectory(prefix='a15_archive_verify_') as d:
  d=Path(d)
